...
<body>
    ...
    if ($_SERVER['REQUEST_METHOD']=='POST') {
        ...
        if ($un && $p) {
            ...
            $q = "SELECT ID, FirstName, LastName, Specialisation, Password FROM Doktor WHERE (ID = '$un' AND Password = '$p')";
            ...
            if (@mysqli_num_rows ($result) == 1) {
                ...
                echo '<p class = "error"> The username and password entered do not match out records
